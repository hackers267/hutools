...
mod test {
    ...
    fn test_between_months() {
        ...
        let result = between_months(date_range);
        let actual = 121;
    ...
    fn test_between_month_1() {
        ...
        let result = between_months(data_range);
        let actual = 120;
        assert_eq!(result, Some(actual));
    }
    #[test]
...
pub fn between_months<Tz>(date_range: (Date<Tz>, Date<Tz>)) -> Option<i64>
where
    Tz: TimeZone,
{
    ...
    diff_year
        ...
        .and_then(|x| diff_month.and_then(|y| (y as i64).checked_add(x as i64)))
}
